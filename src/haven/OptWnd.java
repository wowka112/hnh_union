...
public class OptWnd extends Window {
    ...
    public OptWnd(Coord c, Widget parent) {
        ...
        { /* HIDE OBJECTS TAB */
            ...
            (new Scrollbar(new Coord(225, 70), 150, tab, 0, 255) {
                {
                    val = max - Config.hideColor.getRed();
                }
            ...
            (new Scrollbar(new Coord(255, 70), 150, tab, 0, 255) {
                {
                    val = max - Config.hideColor.getGreen();
                }
            ...
            (new Scrollbar(new Coord(285, 70), 150, tab, 0, 255) {
                {
                    val = max - Config.hideColor.getBlue();
                }
            ...
            (new Scrollbar(new Coord(315, 70), 150, tab, 0, 255) {
                {
                    val = max - Config.hideColor.getAlpha();
                }
