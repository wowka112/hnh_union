...
public class BuddyWnd extends Window {
    ...
    public static final Color[] gc = new Color[]{new Color(255, 255, 255),
            new Color(64, 255, 64), new Color(255, 64, 64),
            new Color(96, 160, 255), new Color(0, 255, 255),
            new Color(255, 255, 0), new Color(211, 64, 255),
    ...
    public class Buddy { //from private to public
        int id;
        public Text name;
        int online;
        int group;
    ...
    public String[] allBuddies() {
        String[] s = new String[buddies.size()];
        for (int i = 0; i < buddies.size(); i++)
            s[i] = buddies.get(i).name.text;
        return s;
    }
    ...
    public String dumpCurrentSelectedInfo() {
        return bi.ava.myown.Dump();
    }

    public String dumpCurrentSelectedName() {
        return bi.name.text;
    }

    public void setHSText(String text) {
        opass.settext(text);
    }

    public void forgetCur() {
        if (bi != null)
            BuddyWnd.this.wdgmsg("rm", bi.id);
    }

    public boolean buddyInfoChanged() {
        return bi.changed();
    }

    public boolean buddyInfoCleared() {
        return bi.changed();
    }
    ...
    private class BuddyInfo extends Widget {
        ...
        private void setatime(int atime) {
            ...
            this.atime = Text.render("Last seen: " + am + " " + unit
                    + ((am > 1) ? "s" : "") + " ago");
        }

        private boolean wasch = false;
        private boolean avach = false;
        ...
        public void uimsg(String msg, Object... args) {
            ...
            if (msg == "i-ava") {
                ...
                this.name = new TextEntry(new Coord(10, 100),
                        new Coord(150, 20), this, name) {
                ...
                if ((fl & 1) != 0)
                    rmb = new Button(new Coord(10, 188), sz.x - 20, this,
                            "Forget") {
                        public void click() {
                ...
                if ((fl & 2) != 0)
                    chatb = new Button(new Coord(10, 165), sz.x - 20, this,
                            "Private chat") {
                        public void click() {
                ...
                if ((fl & 8) != 0)
                    invb = new Button(new Coord(10, 211), sz.x - 20, this,
                            "Invite to party") {
                        public void click() {
                ...
                if ((fl & 16) != 0)
                    descb = new Button(new Coord(10, 234), sz.x - 20, this,
                            "Describe to...") {
                        public void click() {
                ...
                if ((fl & 32) != 0)
                    exb = new Button(new Coord(10, 257), sz.x - 20, this,
                            "Exile") {
                        public void click() {
            ...
            synchronized (buddies) {
                if (buddies.size() == 0) {
                    ...
                    for (int i = 0; i < h; i++) {
                        ...
                        g.aimage(b.name.tex(), new Coord(25, i * 20 + 10), 0,
                                0.5);
                        g.chcolor();
                    }
                }
    ...
    public void sendpwd(String pass) {
        wdgmsg("pwd", pass);
    ...
    public void uimsg(String msg, Object... args) {
        ...
        if (msg == "add") {
            ...
            synchronized (buddies) {
                ...
                b.online = online;
                String str = b.name.text + " is "
                        + ((online > 0) ? "online" : "offline") + " now";
                ui.cons.out.println(str);
                if (Config.onlineNotifier) ui.slenhud.error(str); //Kerri
            }
        } else if (msg == "chnm") {
            int id = (Integer) args[0];
            String name = (String) args[1];
