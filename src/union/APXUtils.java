...
public class APXUtils {
     ...
     *
     * @param uniq     Уникальначя строка (типа гуида). Уникальный идентификатор
     ...
     * @param name     Отображаемое имя кнопки
     * @param tooltip  Отображаемый тултип кнопки
     * @param hotkey   Хоткей
     * @param icon     Ресурс который будет использован в качестве иконки. Это должен
     *                 быть обычный графический ресурс (у него не должно быть лишних
     *                 слоев так что не берите ресы из пагины покачто)
     * @param parent   Элемент который будет использован как родительский. unionRoot
     *                 - корень для всех юнион-фич. Если предок null то кнопка будет
     *                 в полном руте.
     * @param listener Лиснер который вызывается при клике на кнопку. Пример юза
