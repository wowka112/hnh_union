...
public class CustomMenu {
    ...
    public static class MenuElement {
        ...
        public void SetListener(MenuElemetUseListener lst) {
            if (UI.instance != null && UI.instance.menugrid != null && action.length > 1)
                UI.instance.menugrid.listeners.put(action[1], lst);
        }

        public void RemoveListener() {
            if (UI.instance != null && UI.instance.menugrid != null && action.length > 1)
                UI.instance.menugrid.listeners.remove(action[1]);
        }
    }
