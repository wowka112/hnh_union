...
public class JSWindow {
     ...
     *
     * @param bname Точное название кнопки
     */
     ...
     * сверху в низ.
     *
     * @param pos номер позиции кнопки в окне, начинаются с 1.
     */
     ...
     *
     * @param pos позиция лейбла в окне (с единицы)
     * @return текст лейбла
     */
     ...
     * хуй знает в чем)
     *
     * @param pos позиция измерителя в окне
