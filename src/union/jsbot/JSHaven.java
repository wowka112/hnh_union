...
public class JSHaven {
     ...
     *
     * @param rad    радиус поиска объектов (в точках)
     * @param offset оффсет от игрока (в тайлах)
     ...
     * @param btn   кнопка мыши (1 - левая, 3 - правая)
     * @param mod   модификатор клавиатуры (1 - shift; 2 - ctrl; 4 - alt; 8 -
     *              win)
     */
     ...
     *
     * @param point координаты точки назначения
     ...
     *
     * @param c координаты передвижения
     */
     ...
     * тайлах) относительно игрока
     *
     * @param c   координаты оффсета от игрока
     * @param btn кнопка мыши (1 - левая, 3 - правая)
     * @param mod модификатор клавиатуры (1 - shift; 2 - ctrl; 4 - alt; 8 -
     *            win)
     */
     ...
     *
     * @param rc Абсолютные координаты точки
     ...
     *
     * @param text сообщение в игре (как в inGamePrint объекта JSHaven)
     ...
     * @param rad  радиус от игрока (в тайлах)
     * @return объект JSGob или null
     */
     ...
     *
     * @param name  имя ресурса
     * @param rad   радиус поиска (в точках карты)
     * @param coord координаты оффсета от игрока
     ...
     *
     * @param c передаваемые координаты
     ...
     * типом
     *
     * @param raduis радиус поиска тайла (в тайлах)
