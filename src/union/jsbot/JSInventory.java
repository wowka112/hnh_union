...
public class JSInventory {
     ...
     *
     * @param itemmasks Перечисление имен вещей которые надо включить в список
     ...
     * @param type  Тип сортировки. quality - по качеству, iquality -
     *              внутреннее качество (например качество воды в ведре)
     * @param desc  - флаг сортировки. true - по убыванию, false - по
     *              возрастанию
